// ROSE derived-stat + combat formulas, from the original server:
//   src/sho_gameserver/src/common/cuserdata.cpp  (Cal_* derived stats)
//   src/sho_gameserver/src/cobjavt.cpp           (Cal_HIT / Cal_ATTACK / attack speed)
//   src/sho_gameserver/src/common/cobjai.h       (Cal_RunAniSPEED)
//   src/common/calculation.cpp                   (hit success / crit / damage)
// Data-driven inputs (boots speed, weapon AP/speed, item DEF/RES) come from the
// generated DataTables — the formulas here only combine them.  ROSE speeds are
// cm/s, identical to UE units, so RunSpeed maps 1:1 onto MaxWalkSpeed.
#pragma once
